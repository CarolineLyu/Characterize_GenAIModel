...
def prep_data(data=TRAINING_DATA):
    ...
    # rename columns 
    df.columns = [
        'id', 'best_tasks_free', 'acad_tasks_rating', 'best_tasks_select', 'subopt_freq_select',  'subopt_tasks_select', 'subopt_tasks_free', 
        'evidence_freq_select', 'verify_freq_select', 'verify_method_free']
